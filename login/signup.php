...
<body>
    <div class="container-fluid">
        <form method="post" action="./processSignRegistration.php" id="">
        <div class="main-page-grid">
            <div class="signup-content">
                ...
                <div class="get-started">
                    <?php
                    if ($reseult == "101"){?>
                        <div class="btn-container"><button class="btn btn-danger d-block" name="registration" id="registration">Password Mismatch</button></div>
                    <?php
                    }
                    ?>
                    <h2 class="get-stated-title">Get Started</h2>
                    <span class="get-stated-sub-title">already have an account <a class="sign-in" href="./signin.php">sign in</a></span>
                </div>
                <div class="login-items-container">
                    ...
                    <div>
                        <input class="text-field" type="password" name="confirm_password" id="" placeholder="Confirm Passowrd">
                    </div>
                    
                </div>
                <div class="btn-container"><button class="btn btn-primary d-block" name="registration" id="registration">Register</button></div>
            </div>
